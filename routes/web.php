...
Route::get('/artikel/create', 'ArtikelController@create')->name('buat'); // menampilkan halaman form
...
Route::get('/user', 'ArtikelController@user')->name('user');
Route::get('/user/create', 'ArtikelController@buat')->name('tambah');
Route::post('/user', 'ArtikelController@simpan');